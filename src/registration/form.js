...
function Form()
{
    ...
    const [getIcon,setIcon]=useState({icon:'',file:''}) //icon
    
    
   
const handleSubmit=()=>
{
    var formData=new FormData()  //FormData is a key value object
    formData.append('playername',getName)  // {playername : getName}
    formData.append('icon',getIcon.file) 
    var config={headers:{'content-type':'multipart/form-data'}}
    var result= postDataAndImage('add',formData,config)
    console.log(result)
